...
(function(index){                                              //HOSTS content-fix.
  ...
  var REGEX_INVALID_HOSTS_BAD_ASCII   = /^.*[^a-z\d\-\_\.\n]+.*$/igm   //not allowed Unicode/UTF-8 letters.
     ...
     ,REGEX_UNBLOCK_DOMAINS           = /^(s3\.amazonaws\.com|www\.s3\.amazonaws\.com|github\.com|www\.github\.com)$/igm        //those keeps comming back, since the next part removes 'www.' (if the 'www.github','www._____' will not be removed as well), merge those with the existing list again. should add any common-prefix we are going to add ('wss.', 'ws.', ...  - I've simply disabled those so I don't care about adding the 'anti-filter' for now).
